...
class VisualDataObject:
    ...
    def __init__(self, config, data_tuple, side_information_data, *args, **kwargs):
        ...
        if self.side_information_data.shapes_src_folder:
            ...
            if (not self.side_information_data.visual_feature_path) and (
                    not self.side_information_data.visual_pca_feature_path) and (
                        not self.side_information_data.visual_feat_map_feature_path) and (
                            not self.side_information_data.images_src_folder):
                self.item_mapping = pd.read_csv(self.side_information_data.item_mapping_path, sep="\t", header=None)
                self.item_mapping = {i: j for i, j in zip(self.item_mapping[0], self.item_mapping[1])}
        ...
        if self.side_information_data.visual_color_feature_path:
            ...
            sample_feature = os.listdir(self.side_information_data.visual_color_feature_path)[0]
            self.visual_color_features_shape = np.load(
                self.side_information_data.visual_color_feature_path + sample_feature
            ).shape[0]
            if (not self.side_information_data.visual_feature_path) and (
                    not self.side_information_data.visual_pca_feature_path) and (
                        not self.side_information_data.visual_feat_map_feature_path) and (
                            not self.side_information_data.images_src_folder) and (
                                not self.side_information_data.shapes_src_folder):
                self.item_mapping = pd.read_csv(self.side_information_data.item_mapping_path, sep="\t", header=None)
                self.item_mapping = {i: j for i, j in zip(self.item_mapping[0], self.item_mapping[1])}
        ...
        if self.side_information_data.visual_class_feature_path:
            ...
            sample_feature = os.listdir(self.side_information_data.visual_class_feature_path)[0]
            self.visual_class_features_shape = np.load(
                self.side_information_data.visual_class_feature_path + sample_feature
            ).shape[0]
            if (not self.side_information_data.visual_feature_path) and (
                    not self.side_information_data.visual_pca_feature_path) and (
                        not self.side_information_data.visual_feat_map_feature_path) and (
                            not self.side_information_data.images_src_folder) and (
                                not self.side_information_data.shapes_src_folder) and (
                                    not self.side_information_data.visual_color_feature_path):
                self.item_mapping = pd.read_csv(self.side_information_data.item_mapping_path, sep="\t", header=None)
                self.item_mapping = {i: j for i, j in zip(self.item_mapping[0], self.item_mapping[1])}
