...
import elliot.dataset.samplers.pairwise_pipeline_sampler_csv as pairpfs
import elliot.dataset.samplers.pointwise_pipeline_sampler_csv as pointpfs
from elliot.recommender import BaseRecommenderModel
from elliot.recommender.recommender_utils_mixin import RecMixin
from elliot.recommender.proposed.CSV.CSVModel import CSVModel
...
class CSV(RecMixin, BaseRecommenderModel):
    @init_charger
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = CSV_model(self._factors,
                                self._mlp_color,
                                self._mlp_att,
                                self._mlp_out,
                                self._mlp_cnn,
